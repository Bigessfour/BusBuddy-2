...
public class ModelValidationTests
{
    ...
    [Category("ModelValidation")]
    [Category("Vehicle")]
    public void Vehicle_ShouldValidateRequiredProperties()
    {
        // Arrange
        ...
        // Act & Assert
        vehicle.Id.Should().BePositive("Vehicle Id should be positive");
        vehicle.Make.Should().NotBeNullOrEmpty("Make is required");
        vehicle.Model.Should().NotBeNullOrEmpty("Model is required");
        vehicle.PlateNumber.Should().NotBeNullOrEmpty("PlateNumber is required");
        vehicle.Capacity.Should().BePositive("Capacity should be positive");
    }

    [Test]
    [Category("ModelValidation")]
    [Category("Vehicle")]
    public void Vehicle_ShouldValidateRealisticCapacity()
    {
        // Arrange & Act
        var smallBus = new Vehicle { Capacity = 15 };
        var standardBus = new Vehicle { Capacity = 72 };
        var largeBus = new Vehicle { Capacity = 90 };
        var oversizedBus = new Vehicle { Capacity = 150 };
