...
function Start-RootDirectoryOrganization {
    ...
    Move-FileToLocation "steve-happiness-matrix-v2.ps1" "Archive\Legacy-Scripts\steve-happiness-matrix-v2.ps1" "Legacy experimental script"
    Move-FileToLocation "steve-happiness-tracker.ps1" "Archive\Legacy-Scripts\steve-happiness-tracker.ps1" "Legacy experimental script"
    Move-FileToLocation "steve-rewards.json" "Archive\Legacy-Scripts\steve-rewards.json" "Legacy experimental data"
