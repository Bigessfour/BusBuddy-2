...
namespace BusBuddy.WPF.ViewModels
{
    ...
    public class DriversViewModel : BaseViewModel
    {
        ...
        public DriversViewModel(BusBuddyDbContext context)
        {
            ...
            RefreshCommand = new RelayCommand(async _ => await RefreshDriversAsync(), _ => !IsLoading);
            ...
            DeleteDriverCommand = new RelayCommand(async _ => await DeleteDriverAsync(), _ => SelectedDriver != null && !IsLoading);
