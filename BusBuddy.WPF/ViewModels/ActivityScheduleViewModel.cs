...
namespace BusBuddy.WPF.ViewModels
{
    ...
    public class ActivityScheduleViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        public ActivityScheduleViewModel()
        {
            ...
            RefreshCommand = new RelayCommand(_ => { _ = LoadActivitySchedulesAsync(); });
            AddActivityCommand = new RelayCommand(_ => AddNewActivity());
            EditActivityCommand = new RelayCommand(_ => EditActivity(), _ => SelectedActivity != null);
            ViewDetailsCommand = new RelayCommand(_ => ViewDetails(), _ => SelectedActivity != null);
            ConfirmActivityCommand = new RelayCommand(_ => { _ = UpdateActivityStatus("Confirmed"); }, _ => SelectedActivity != null);
            StartActivityCommand = new RelayCommand(_ => { _ = UpdateActivityStatus("In Progress"); }, _ => SelectedActivity != null);
            CompleteActivityCommand = new RelayCommand(_ => { _ = UpdateActivityStatus("Completed"); }, _ => SelectedActivity != null);
            CancelActivityCommand = new RelayCommand(_ => { _ = UpdateActivityStatus("Cancelled"); }, _ => SelectedActivity != null);
