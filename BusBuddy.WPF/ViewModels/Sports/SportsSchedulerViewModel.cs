...
namespace BusBuddy.WPF.ViewModels.Sports
{
    ...
    public class SportsSchedulerViewModel : BaseViewModel, IDisposable
    {
        ...
        public SportsSchedulerViewModel()
        {
            ...
            AddSportsEventCommand = new RelayCommand(async _ => await AddSportsEventAsync());
            EditActivityCommand = new RelayCommand(async _ => await EditActivityAsync(), _ => SelectedActivity != null);
            DeleteActivityCommand = new RelayCommand(async _ => await DeleteActivityAsync(), _ => SelectedActivity != null);
            AssignVehicleCommand = new RelayCommand(async _ => await AssignVehicleAsync(), _ => SelectedActivity != null && SelectedVehicle != null);
            AssignDriverCommand = new RelayCommand(async _ => await AssignDriverAsync(), _ => SelectedActivity != null && SelectedDriver != null);
            CheckConflictsCommand = new RelayCommand(async _ => await CheckConflictsAsync());
        ...
        private void OnSelectedActivityChanged()
        {
            ...
            ((RelayCommand)EditActivityCommand).RaiseCanExecuteChanged();
            ((RelayCommand)DeleteActivityCommand).RaiseCanExecuteChanged();
            ((RelayCommand)AssignVehicleCommand).RaiseCanExecuteChanged();
            ((RelayCommand)AssignDriverCommand).RaiseCanExecuteChanged();
        }
