...
namespace BusBuddy.WPF.Views.Activity
{
    ...
    public class ActivityScheduleEditDialogViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<BusBuddy.Core.Models.Vehicle> AvailableVehicles { get; } = new();
        ...
        private async void LoadAvailableData()
        {
            try
            {
        ...
        private void LoadSampleVehicles()
        {
            ...
            AvailableVehicles.Add(new BusBuddy.Core.Models.Vehicle { Id = 1, Make = "Blue Bird", Model = "Vision", PlateNumber = "Bus-001", Capacity = 72 });
            AvailableVehicles.Add(new BusBuddy.Core.Models.Vehicle { Id = 2, Make = "Blue Bird", Model = "Vision", PlateNumber = "Bus-002", Capacity = 71 });
            AvailableVehicles.Add(new BusBuddy.Core.Models.Vehicle { Id = 3, Make = "Thomas", Model = "C2", PlateNumber = "Bus-003", Capacity = 77 });
            AvailableVehicles.Add(new BusBuddy.Core.Models.Vehicle { Id = 4, Make = "Thomas", Model = "C2", PlateNumber = "Bus-004", Capacity = 72 });
            AvailableVehicles.Add(new BusBuddy.Core.Models.Vehicle { Id = 5, Make = "IC Bus", Model = "CE200", PlateNumber = "Bus-005", Capacity = 78 });
        }
